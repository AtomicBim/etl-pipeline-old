...
OUTPUT_FILE = 'tim_export_plugin_development_stage.csv'
...
SCHEMA = "plugins"
TABLE = "plugin_development_stage"
...
def main():
    """Основная функция для экспорта таблицы plugin_development_stage из PostgreSQL."""
    try:
        logger.info("Начало экспорта таблицы plugin_development_stage из PostgreSQL")
        ...
        logger.info("Экспорт данных plugin_development_stage завершен успешно")
        
    except Exception as e:
        logger.error(f"Ошибка при экспорте таблицы plugin_development_stage: {e}")
        raise
