...
OUTPUT_FILE = 'tim_export_ad_user.csv'
...
def main():
    """Основная функция для экспорта таблицы ad_user из PostgreSQL."""
    try:
        logger.info("Начало экспорта таблицы ad_user из PostgreSQL")
        ...
        logger.info("Экспорт данных ad_user завершен успешно")
        
    except Exception as e:
        logger.error(f"Ошибка при экспорте таблицы ad_user: {e}")
        raise
