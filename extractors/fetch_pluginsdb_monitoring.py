...
OUTPUT_FILE = 'tim_export_monitoring.csv'
...
def main():
    """Основная функция для экспорта таблицы monitoring из PostgreSQL."""
    try:
        logger.info("Начало экспорта таблицы monitoring из PostgreSQL")
        ...
        logger.info("Экспорт данных monitoring завершен успешно")
        
    except Exception as e:
        logger.error(f"Ошибка при экспорте таблицы monitoring: {e}")
        raise
